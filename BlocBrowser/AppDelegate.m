...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"Welcome", @"welcome title") message:NSLocalizedString(@"awesome browser for surfing stuff your wife shouldn't know about", @"welcome comment") delegate:nil cancelButtonTitle:NSLocalizedString(@"Go!", @"welcome button title") otherButtonTitles:nil];
